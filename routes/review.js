...
router.post('/', function(req, res, next) {
    ...
    req.body.reviewdate, req.body.comments, req.body.rating, req.body.status],(err, result) => {
        if (err) {
            console.log(err);
            res.render('error');
        } else {
...
router.post('/save', function(req, res, next) {
    ...
    db.query(updatequery,[req.body.review_id, req.body.customer_id, req.body.product_id,
    req.body.reviewdate, req.body.comments, req.body.rating, req.body.status],(err, result) => {
        if (err) {
            console.log(err);
            res.render('error');
