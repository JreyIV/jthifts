...
router.post('/', function(req, res, next) {
    ...
    db.query(insertquery,[req.body.order_id, req.body.product_id,
    req.body.saleprice, req.body.qty],(err, result) => {
        if (err) {
            console.log(err);
            res.render('error');
        } else {
...
router.post('/save', function(req, res, next) {
    ...
    db.query(updatequery,[req.body.orderdetail_id, req.body.order_id, req.body.product_id,
    req.body.saleprice, req.body.qty],(err, result) => {
        if (err) {
            console.log(err);
            res.render('error');
