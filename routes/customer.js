...
// URL = http://localhost:3026/customer/login
// ==================================================
...
// ==================================================
// Route Check Login Credentials
// URL = http://localhost:3026/customer/logout
// ==================================================
...
// URL = http://localhost:3026/customer/
// ==================================================
...
// http://localhost:3026/customer/register
// ==================================================
...
router.post('/', function(req, res, next) {
    ...
    req.body.email, req.body.phone, req.body.address1, req.body.address2, req.body.city,
    req.body.state, req.body.zip, req.body.username, hash],(err, result) => {
        if (err) {
            console.log(err);
            res.render('error');
        } else {
...
router.post('/save', function(req, res, next) {
    let updatequery = "UPDATE customer SET customer_id = ?, firstname = ?, lastname = ?, email = ?, phone = ?, address1 = ?, address2 = ?, city = ?, state = ?, zip =?, username = ?, password = ? WHERE customer_id = " + req.body.customer_id;
